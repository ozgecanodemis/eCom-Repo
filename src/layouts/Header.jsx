            ...
            <div className="container mx-auto px-4 py-4 ">
                ...
                {isMenuOpen && (
                    <nav className="mt-8 flex flex-col items-center space-y-8 md:hidden">
                        <Link to="/" className="text-secondTextColor text-[30px] hover:text-gray-900">Home</Link>
                        <Link to="/product" className="text-secondTextColor text-[30px] hover:text-gray-900">Product</Link>
                        <Link to="/pricing" className="text-secondTextColor text-[30px] hover:text-gray-900">Pricing</Link>
                        <Link to="/contact" className="text-secondTextColor text-[30px] hover:text-gray-900">Contact</Link>
                    </nav>
                )}
            </div>
        </header>
