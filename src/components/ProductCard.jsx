const ProductCard = () => {
    return (
        <div className="text-center sm:w-[348px] sm:h-[427px]">
            <img src="https://picsum.photos/200/300" alt="Product" className="mx-auto mx-auto  w-[183px] h-[162px] object-cover w-24 h-24" />
